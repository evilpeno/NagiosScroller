...
It's purpose is to parse Nagios Alerts thru a special CGI script and display them
on a brunch of 8X8 matricial led displays powered with max7219.
When there's no alerts, display a scrolling dot every 5s.
Display alerts elsewhere.
